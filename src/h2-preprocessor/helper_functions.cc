...
void generate_cpp_input(string output_file_name, bool /*solvable_in_poly_time*/,
    ...
    ofstream outfile;
    outfile.open(output_file_name.c_str(), ios::out);
...
void generate_unsolvable_cpp_input(string output_file_name) {
    ofstream outfile;
    outfile.open(output_file_name.c_str(), ios::out);
    outfile << "begin_version" << endl;
    outfile << PRE_FILE_VERSION << endl;
